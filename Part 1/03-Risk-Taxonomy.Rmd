...
Additional major categoris from Lam
...
Risk from $\Delta$ interest rates level or shae of the yield curve
...
* Risk that a counterparty to an agreement will be unable or unwilling to make the payments required (Doesn't have to be bankruptcy)
...
Party behaves inappropriately or less carefully than they would otherwise, leaving the organiztion to bear some of the consequences of the action
...
* Age profile, eduational standards, health standards, economic wealth, attitudes and lifestyles
...
* Can derisk by switching to DC plans and buying-out liabilities
...
* Riskof lower sales due to $\Delta$ in market conditions, where the market is where produces and services are sold
...
* Credit risk and counterparty risk are use interchangably sometimes

Different definitions of Business Risk

* All risks to which businesses are exposed
* Subest of risks which are specific to the type of business undertaken (e.g. insurance risks for insurance co.)
...
* Systemic can means the same but is often used more specifically to refer to the risk of problems spreading betweens entities following a trigger event (basically contagion risk)
...
There are market wide contagion risks that can affect and destabilise whole sectors, particularly financial institutions
...
* Exposure to a common counterparty, where a failure in one organization causes another to fail or creates a lack of confidence in the sector
    * E.g. Default of a company and lead to its creditors and suppliers experience financial diffiulties and create a chain reaction
