...
* Role of regulators in EMR and effective management of the supervisor relationship
...
External parties may prescribe or limit a company's activites or demand certain standards (e.g. capital requirement) to minimize risk to various stakeholers
...
Prudential supervisory processess:
...
* Subsidiaries that a new ventures or acquisitions and are at different lifecycle stages

#### Categories of supervisors 

In addition to government

**Professional bodies** (e.g. IFA)

Role:

* Ensure members are adequately trained (through exams)
* Ensure members maintain their competence, throgh CE
* Some can discipline members that fail to maintain appropriate standards

**Professional regulators** (e.g. CFA, FRC)
...
* Goal is to prevent problems occuring rather than punishing
...
* Pros:
    * Easeir to regulate conglomerats
    ...
    * Improved accountability (less change of buck-passing between regulators)
...
Reasons insurer should **engage proactively** with their supervisors

* Insurer-regulator relationship should be a key component of an insurer's ERM framework
* Regulatory enganges in risk-based regulation (focusing on riskiest companies) and by proactively engaging regulators, it helps to reduce the level of risk a supervisor places on a particular insurer
* Regulators are also well place to advise on what is best practice (as they see a wide range of RM practices), more likely to benefit from such adivce with proactive engagement
...
* Aim: protect consumers; ensure stability of industry; promote healthy competition

Prudential Regulation Authority:

* Park of Bank of England
* Responsible for prudential regulation and supervision of banks, building societies, credit unions, insurers, investment firms
...
* Ensures that companies either comply with the Combined Coe of Corporate Governance 2003, or state why they are not
* Has power to suspend trading in a company's share or cancel their listing
* So similar to SEC?

#### London Stock Exchange (LSE)

* Has 2 main traded markets: main market and alternative investment market (AIM)
* There are >300 companies that are traded as "members" (i.e. they eal directly with one another through the exchange, other companies have to dal with member firms, who then hedge their own positions)
* LSE is regulated by the Office of Fair Trading (OFT) and its servcies must comply with certain standards such as EU market standards set out in the Investment SErvices Directive (ISD)

## Basel Accords

Focus here is on the 3 pillars

Banks are regulated by the country they are based in (e.g. PRA for UK) but countries alos adopt recommendations from European and international organizations

Basel Committee on Banking Supervisions (BCS, under Bank for International Settlements BIS) publishes the Basel regulations (for supervising banks)
...
* Basel III: developed post 2008 to works alongside Basel II and focuses primarily on specific liquidity, systemic and counterparty risks
...
Supervisors will assess the banks's internal systems, processes and risk limits to ensure that the bank has set aside sufficient capital for its risks  

Liquidity and concentration risk is a particular focus

***Pillar 3:***

Deals withthe level of **disclosure** that the bank is required to undertake to the public and the market  
...
Some risk (e.g. liqudity) are only given cursory consideration

More complex calculations $\neq$ more reliable calculations

**Costly** to implement particularly if banks want to use internal model (to take advantage of the more beneficial capital regimes)

**Risk-herding**, since banks all measure risk the same way, they might tyr to protect themselves in the same way at the same time of crisis

MV may undervalue certain assets (e.g. gov fixed income)

Implied levels of confidence could be spurious as some securities (e.g. CDOs) have not existed for very long

**Pro-cyclicality**, the systemic risk that assets may need to be sold if their market value falls, which forces price even lower
...
Allows some flexibiility in capital requirements in times of financial crisis to limit pro-cyclicality

Criticisim: continue to use risk-weighting dependent upon subjective rating agency assessments
...
Emphasis on the fact that **capital is not the only (or best) way** to miliate against failures

More **prospective** focus

Streamlined approach which aims to recognise the **eonomic reality** of how groups operate
...
* Thresholds:
    * Solvency Capital Requirement (SCR): below which regulatory action is taken
    * Minimum Capital Requirement (MCR): below which authoriztion if foregone

***Pillar 2***

**Qualitative** requirements

* Requirements on undertakings such as risk management well as supervisory activities
...
* Quantify is ongoing ability to continue to meet is solvency capital requirements (both MCR and SCR)
    * Projections of financial position over terms longer than that normally required to calculate regulatory capital reqirements
* Analyse quantitatibe and qualitative elements of its business strategy
...
* Allowing requlators to enhance their assessments of the ability of insurance companies to withstan stress events
...
* Largely risk-based (vs SI was volume based) e.g. allocate capital to business areas that run the highest risk (can deal with embeded options, guarantees, and other non-volume related risk)
...
* SII was not designed with systemic risk in mind as it is considered unlikely that the demise of one insurer will affect others