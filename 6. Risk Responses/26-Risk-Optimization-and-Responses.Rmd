...
4. Employ techniques to **manage existing risks**
    ...
    iii. **Transfer risk** to a 3^rd^ party:
...
***Some more risk transfer "Must"***

* Based on good **mutual understanding** of each of the parties' **objectives**

* Recognize the ability of the party assuming the risk to take action and understand the context of the risk
