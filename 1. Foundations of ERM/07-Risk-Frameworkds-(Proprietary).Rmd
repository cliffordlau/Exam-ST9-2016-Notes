...
1. ***Risk Management Culture***
    ...
    i. **Communication** of risk through all levels of the company

    ii. **Documenting** and **analysis** of **past errors**

    iii. **Consistency** of risk management across all pars of the business

    iv. **Incentivizing** of good RM practices within the firm

    Other areas of evaluation

    v. **Governance** structure

    vi. **Risk tolerance** statements

    vii. *Capabilities* of **individual risk managers**
...
2. ***Risk Control***
    ...
    * How the **risk retention limits** will be **adhered** to and the 
...
5. ***Strategic Risk Management***
    ...
    i. *Clear decision making* w.r.t. the **retained risks**

        Whether the company should refocus to `avoid` or `diversify` the risks

    ii. *Clear strategy* for **assets investment**

        Focusing on the allocation across `broad categories` (e.g. equities vs bonds) and across `countries`

    iii. **Pricing strategy** that *reflects* **risk/return trade off**

        Clear standards set of acceptable risk/return profiles

    iv. *Appropriate* **capital allocation** between the different BUs based on the capital model

    v. *Appropriate* **dividend policy**
    ...
    vi. Good risk-adjusted returns should be **rewarded** within the company