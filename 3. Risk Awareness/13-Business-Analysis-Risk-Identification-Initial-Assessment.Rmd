...
2. [***Identify the risks***](#risk-ass-pross)
...
### Risk Assessment Process{#risk-ass-pross}
...
2. ***Cloud computing***
    ...
    * Reduce amount of control over the data and increases the reliance on the risk management capabilities of the 3^rd^ party provider
