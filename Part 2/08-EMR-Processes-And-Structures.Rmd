...
* Re command a structure for an organization's RM function
...
An organization's overall strategy involves assessing its value chain, core competencies and the risk/return economies of the overall business to decide where in the value chain it ought to compete

Strategy covers a wide range of different corporate decisions (sales growth, product choices, distribution, target markets etc)
...
The degree to which risks are embraced or mitigated can be a key part of the overall strategy above
...
* Company that is in difficulty may take decisions that adversely affect some stakeholders $\Rightarrow$ Can reduce the profitability and value of the company
...
**Horizon Scanning** and **Flexibility**
...
2. Embedding **resilience** and **flexibility** into corporate structures
    * It'll help deal with problems that aren't spotted sufficiently early to facilitate appropriate mitigation
...
Important for an organization to have well defined risk metrics and risk reporting systems to ensure the the monitoring stage is robust
